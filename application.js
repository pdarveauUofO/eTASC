...
PouchNotesObj.prototype.savenote = function () {
    ...
    */
	...
	o.notetitle = (this.formobject.notetitle.value == '') ?  "Start Offset:" + " " + this.formobject.inputstartoff.value + " , " + "End Offset:" + " " + this.formobject.inputendoff.value : this.formobject.notetitle.value;
    o.annclass = (this.formobject.annclass.value == '') ? 'Untitled Note' : this.formobject.annclass.value;
    o.inputstartoff = (this.formobject.inputstartoff.value == '') ? 'Untitled Note' : this.formobject.inputstartoff.value;
    o.inputendoff = (this.formobject.inputendoff.value == '') ? 'Untitled Note' : this.formobject.inputendoff.value;
...
PouchNotesObj.prototype.addrow = function (obj) {
    ...
    // a.innerHTML = obj.doc.annclass === undefined ? 'Untitled Note annclass' : obj.doc.annclass;
    td.appendChild(a);
    tr.appendChild(td);
...
PouchNotesObj.prototype.search = function(searchkey) {
	...
	var map = function(doc) {
		...
		*/
		...
		// if( regex.test(doc.annclass) || regex.test(doc.note) || regex.test(doc.tags) ){
		if( regex.test(doc.inputendoff) || regex.test(doc.inputstartoff) || regex.test(doc.annclass) || regex.test(doc.notetitle) || regex.test(doc.note) || regex.test(doc.tags) ){		
			 emit(doc._id, {notetitle: doc.notetitle, annclass: doc.annclass, inputstartoff: doc.inputstartoff, inputendoff: doc.inputendoff, id: doc._id, modified: doc.modified});
			// emit(doc._id, {annclass: doc.annclass, id: doc._id, modified: doc.modified});
		}
	}
